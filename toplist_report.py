...
domains dropped. The selection rule is the published ranking rather than editorial judgement,
so the sample means the same thing every month.
</p>
<p>
Built for the NSERC Summer 2026 research project by E. Deveci, supervised by
Prof. Samer Lahoud, Faculty of Computer Science, Dalhousie University.
</p>
</section>
</div>
