...
for row in rows:
    ...
    if row.get("tls_version", "").strip() == "":
        ...
        # self-hosted means the org runs its own TLS. and if the site belongs
        # to the CDN company itself, that also counts as their own infra.
